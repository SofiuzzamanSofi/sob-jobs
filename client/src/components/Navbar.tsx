            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        ref={profileRef}
                        className={`py-4 px-8 rounded-lg shadow-md bg-white dark:bg-gray-800 absolute top-[4.75rem] md:top-[5.25rem] right-0 z-30 ${isProfileOpen ? "translate-x-0" : "translate-x-[3000px]"} duration-1000 transition-all border`}
                    >
                        ...
                        >
                            ...
                            <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                                <ul className="space-y-1.5">
                                    ...
                                    >
                                        <svg className="w-3.5 h-3.5 dark:bg-white rounded-full" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 512 512">
                                            ...
                                            <ul className="hs-accordion-group pl-3 pt-2 space-y-3" data-hs-accordion-always-open>
                                                <li className="hs-accordion" id="users-accordion-sub-1">
                                                    ...
                                                    <ul className="pt-2 pl-2 space-y-2">
                                                        <li>
                                                            <a className="block py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="javascript:;">
                                                                Link 1
                                                            </a>
                                                        </li>
                                                        <li>
