            ...
            <>
                {/* <>
                    ...
                    >
                        ...
                        >
                            © 2023 Sob-Jobs. A product of Sofi
                        </h6>
                    </div>
                </> */}
                ...
                <>
                    <footer className='border-t bg-white dark:bg-gray-800'>
                        <div className="max-w-[85rem] py-10 px-4 mx-auto">


                            <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
                                <div>
                                    {/* <Link
                                        className="flex-none text-xl font-semibold text-black dark:text-white text-center md:text-left mx-auto"
                                        aria-label="Brand"
                                        href="/"
                                    >
                                    ...
                                    <Link className="flex-none text-xl font-semibold text-black dark:text-white"
                                        aria-label="Brand"
                                        href="/"
                                    >
                                        <Image
                                            src={logo}
                                            alt=''
                                            className='h-[2.904rem] md:h-[4.248rem] w-[10.164rem] md:w-[14.868rem] rounded-md mx-auto md:ml-0'
                                        />
                                    </Link>
