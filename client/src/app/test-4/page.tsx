...
//     }
//     console.log('currentMenu("/test-44"):', currentMenu("/test-44"));
...
//     ${currentMenu("/test-44") ? "bg-gray-100 dark:bg-gray-900" : ""}
//     `
...
//                 ref={menuRef}
//                 className={`translate-x-[-3000px] md:translate-x-0  transition-all duration-800 transform fixed top-0 left-0 bottom-0 z-[60] w-64  border-r p-1 md:p-4 border-gray-200 overflow-y-auto scrollbar-y dark:scrollbar-y  lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 bg-white dark:bg-gray-800 dark:border-gray-700`}
//             >
